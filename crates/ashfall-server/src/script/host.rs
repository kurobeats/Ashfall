...
fn set_object_pos(caller: &Caller<'_, ScriptState>, id: i64, pos: [f32; 3]) {
    let registry = &caller.data().registry;
    let Some(arc) = registry.get(NetworkID::new(id as u64)) else {
        return;
    };
...
fn with_item(
    ...
    match guard
        .as_any_mut()
        .downcast_mut::<crate::world::objects::Item>()
    {
        Some(item) => {
            f(item);
            true
...
fn with_actor(caller: &Caller<'_, ScriptState>, id: u64, f: impl FnOnce(&mut Actor)) -> bool {
    let Some(arc) = caller.data().registry.get(NetworkID::new(id)) else {
        return false;
    };
    let mut guard = arc.write();
    ...
    if let Some(p) = guard
        .as_any_mut()
        .downcast_mut::<crate::world::objects::Player>()
    {
        f(&mut p.actor);
        return true;
    }
...
fn link_item_to_container(caller: &Caller<'_, ScriptState>, item: u64, container: u64) {
    ...
    let mut guard = arc.write();
    let items = if let Some(c) = guard
        .as_any_mut()
        .downcast_mut::<crate::world::objects::Container>()
    {
        &mut c.items
...
impl HostFunctions {
    ...
    pub fn define_in_linker(&self, linker: &mut Linker<ScriptState>) -> anyhow::Result<()> {
        // ── Server management ──
        linker.func_wrap(
            "env",
            "get_max_players",
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, ref_id: i32, base_id: i32, cell: i32| -> i64 {
                ...
                let obj = crate::world::objects::Object::new(
                    id,
                    ref_id as u32,
                    base_id as u32,
                    cell as u32,
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, ref_id: i32, base_id: i32, cell: i32| -> i64 {
                let state = caller.data();
                let id = state.registry.allocate_id();
                let actor = crate::world::objects::Actor::new(
                    id,
                    ref_id as u32,
                    base_id as u32,
                    cell as u32,
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, id: i64, index: i32| -> f32 {
                let state = caller.data();
                let Some(arc) = state.registry.get(NetworkID::new(id as u64)) else {
                    return 0.0;
                };
                let guard = arc.read();
                guard
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, id: i64, index: i32, value: f32| {
                ...
                if let Some(actor) = guard
                    .as_any_mut()
                    .downcast_mut::<crate::world::objects::Actor>()
                {
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, id: i64| {
                ...
                let Some(arc) = state.registry.get(nid) else {
                    return;
                };
                let mut guard = arc.write();
                if let Some(actor) = guard
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::UpdateActorDead {
                        id: nid,
                        dead: false,
                        limbs: 0,
                        cause: 0,
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, id: i64, level: i32| {
                ...
                if let Some(obj) = guard
                    .as_any_mut()
                    .downcast_mut::<crate::world::objects::Object>()
                {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::UpdateLock {
                        id: nid,
                        lock: level as u32,
                    }));
            },
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, ScriptState>, a: i32, b: i32, hostility: i32| {
                ...
                caller
                    .data_mut()
                    .factions
                    .set_relation(a as u32, b as u32, h);
            },
        )?;
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, ref_id: i32, base_id: i32, container: i64| -> i64 {
                let state = caller.data();
                let id = state.registry.allocate_id();
                let item = crate::world::objects::Item::new(
                    id,
                    ref_id as u32,
                    base_id as u32,
                    NetworkID::new(container as u64),
                );
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, ScriptState>,
             ...
             -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::WindowNew {
                        id,
                        parent: NetworkID::new(parent as u64),
                        label,
                        pos: [0.0; 4],
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, id: i64| {
                caller
                    .data()
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::WindowRemove {
                        id: NetworkID::new(id as u64),
                    }));
            },
        )?;
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, id: i64, x: f32, y: f32, ox: f32, oy: f32| {
                caller.data().effects.push(ScriptEffect::BroadcastPacket(
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, ScriptState>,
             ...
             -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::ButtonNew {
                        id,
                        parent: NetworkID::new(parent as u64),
                        label,
                        pos: [0.0; 4],
                        size: [64.0, 24.0, 0.0, 0.0],
                        locked: false,
                        visible: true,
                        text: String::new(),
                    }));
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, ScriptState>,
             ...
             -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::TextNew {
                        id,
                        parent: NetworkID::new(parent as u64),
                        label: text.clone(),
                        pos: [0.0; 4],
                        size: [100.0, 20.0, 0.0, 0.0],
                        locked: false,
                        visible: true,
                        text,
                    }));
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, parent: i64, max_len: i32| -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::EditNew {
                        id,
                        parent: NetworkID::new(parent as u64),
                        label: String::new(),
                        pos: [0.0; 4],
                        size: [200.0, 24.0, 0.0, 0.0],
                        locked: false,
                        visible: true,
                        text: String::new(),
                        max_len: max_len.max(0) as u32,
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, ScriptState>,
             ...
             -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::CheckboxNew {
                        id,
                        parent: NetworkID::new(parent as u64),
                        label,
                        pos: [0.0; 4],
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, parent: i64, group: i32| -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::RadioButtonNew {
                        id,
                        parent: NetworkID::new(parent as u64),
                        label: String::new(),
                        pos: [0.0; 4],
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, parent: i64, multiselect: i32| -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::ListNew {
                        id,
                        parent: NetworkID::new(parent as u64),
                        label: String::new(),
                        pos: [0.0; 4],
                        size: [200.0, 200.0, 0.0, 0.0],
                        locked: false,
                        visible: true,
                        text: String::new(),
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, ScriptState>,
             ...
             -> i64 {
                ...
                state
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::ListItemNew {
                        id,
                        container: NetworkID::new(list_id as u64),
                        text,
                        selected: false,
                    }));
                id.as_u64() as i64
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, item_id: i64| {
                caller
                    .data()
                    .effects
                    .push(ScriptEffect::BroadcastPacket(Packet::ListItemRemove {
                        id: NetworkID::new(item_id as u64),
                    }));
            },
        )?;
        ...
        linker.func_wrap(
            ...
            |mut caller: Caller<'_, ScriptState>,
             ...
             -> i32 {
                ...
                let cb = if cb.is_empty() {
                    "script_timer".to_string()
                } else {
                    cb
                };
                let state = caller.data();
        ...
        linker.func_wrap(
            ...
            |caller: Caller<'_, ScriptState>, quest_id: i32, stage: i32| {
                caller
                    .data()
                    .quests
                    .set_stage(quest_id as u32, stage.max(0) as u16);
            },
        )?;
        linker.func_wrap(
            "env",
